...
class env():
    ...
    def __init__(self):
        ...
        self.objtargetAlpha=round(random.uniform(0,90),0)

        self.objX=round(random.uniform(-0.2,0.2),2)
        self.objY=round(random.uniform(-0.2,0.2),2)
        self.objZ=0.02
        self.objAlpha=round(random.uniform(0,90),0)
    ...
    def pos_award(self):
        ...
        if(self.object_uhvacen):
            self.position_award=math.sqrt((self.objX-self.objtargetX)**2+(self.objY-self.objtargetY)**2+(self.objZ-self.objtargetZ)**2)+abs((self.objAlpha-self.objtargetAlpha)/10)
        else:
        ...
        if(math.sqrt((self.objX-self.objtargetX)**2+(self.objY-self.objtargetY)**2)<=0.03):
            if(abs(self.objAlpha-self.objtargetAlpha)<=1 ):
                return 1
        if(award<0):
            return 0.05
        else:
    ...
    def move(self,action):
        ...
        if(self.object_uhvacen==True):
            ...
            self.objZ+=movZ
            if(action==7):
                 self.objAlpha+=self.step_rotate
                 if(self.objAlpha>90):
                     self.objAlpha+=-90
            if(action==8):
                self.objAlpha-=self.step_rotate
    ...
    def reset(self):
        ...
        return np.array( [self.botX-self.objX,self.botY-self.objY,self.botZ-self.objZ,self.botX-self.objtargetX,self.botY-self.objtargetY,self.botZ-self.objtargetZ,self.vacuum_on,self.object_uhvacen,self.objAlpha-self.objtargetAlpha])
    def step(self,action):
         self.timestamp+=1
        
         
         if(self.timestamp==149):
             return  np.array([self.botX-self.objX,self.botY-self.objY,self.botZ-self.objZ,self.botX-self.objtargetX,self.botY-self.objtargetY,self.botZ-self.objtargetZ,self.vacuum_on,self.object_uhvacen,self.objAlpha-self.objtargetAlpha]),-1,True
         ...
         if(action==6):
            ...
            if(vacuum):
                if(self.first_vacuum==False):
                    ...
                    return  np.array([self.botX-self.objX,self.botY-self.objY,self.botZ-self.objZ,self.botX-self.objtargetX,self.botY-self.objtargetY,self.botZ-self.objtargetZ,self.vacuum_on,self.object_uhvacen,self.objAlpha-self.objtargetAlpha]),0.8,False
                    
                else:
                   return  np.array([self.botX-self.objX,self.botY-self.objY,self.botZ-self.objZ,self.botX-self.objtargetX,self.botY-self.objtargetY,self.botZ-self.objtargetZ,self.vacuum_on,self.object_uhvacen,self.objAlpha-self.objtargetAlpha]),-0.1,False
                     
         if self.collision_detect():
            return  np.array([self.botX-self.objX,self.botY-self.objY,self.botZ-self.objZ,self.botX-self.objtargetX,self.botY-self.objtargetY,self.botZ-self.objtargetZ,self.vacuum_on,self.object_uhvacen,self.objAlpha-self.objtargetAlpha]),-0.8,True
        
         aw=self.pos_award()
         if(aw==1):
            return  np.array([self.botX-self.objX,self.botY-self.objY,self.botZ-self.objZ,self.botX-self.objtargetX,self.botY-self.objtargetY,self.botZ-self.objtargetZ,self.vacuum_on,self.object_uhvacen,self.objAlpha-self.objtargetAlpha]),1,True
         else:
            return  np.array([self.botX-self.objX,self.botY-self.objY,self.botZ-self.objZ,self.botX-self.objtargetX,self.botY-self.objtargetY,self.botZ-self.objtargetZ,self.vacuum_on,self.object_uhvacen,self.objAlpha-self.objtargetAlpha]),aw,False


    def observation(self):
        return [self.botX-self.objX,self.botY-self.objY,self.botZ-self.objZ,self.botX-self.objtargetX,self.botY-self.objtargetY,self.botZ-self.objtargetZ,self.vacuum_on,self.object_uhvacen,self.objAlpha-self.objtargetAlpha]
